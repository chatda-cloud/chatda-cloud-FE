      ...
      onTap: () => Navigator.of(context, rootNavigator: true).push(
        MaterialPageRoute(
          builder: (_) => MatchDetailScreen(
            ...
            counterpartLocation: location,
            counterpartDate: date,
            counterpartTags: tags,
            counterpartImageUrl: imageUrl,
          ),
        ),
      ),
      child: Card(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(builder: (_) => MatchDetailScreen(
          ...
          counterpartLocation: item['location'] ?? '',
          counterpartDate: item['date'] ?? '',
          counterpartTags: List<String>.from(item['tags'] ?? []),
          counterpartImageUrl: item['imageUrl'] ?? item['image_url'],
        )));
      },
      child: Card(
